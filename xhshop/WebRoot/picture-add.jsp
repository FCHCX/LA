...
<div id="scrollsidebar" class="left_Treeview">
   ...
   <%-- <form id="itemForm" action="${pageContext.request.contextPath}/items/editItemsSubmit.action " class="form form-horizontal" method="post" enctype="multipart/form-data"> --%>
	 <form action="${pageContext.request.contextPath}/items/addItems.action " method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data"> 
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>商品名称：</label>
		 <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="" name="sname"></div>
		</div>
		<div class=" clearfix cl">
         <label class="form-label col-2">商品明细：</label>
	     <div class="formControls col-10"><input type="text" class="input-text" value="" placeholder="" id="" name="sdetail"></div>
		</div>
		<div class=" clearfix cl">
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="stype"></div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">品&nbsp;&nbsp;&nbsp;&nbsp;牌：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="sbrand"></div>
			</div>
             <div class="Add_p_s">
             <label class="form-label col-2">商品重量：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="sweight" >kg</div>
			</div>
             
            <div class="Add_p_s">
             <label class="form-label col-2">商品单价：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="sprice" >元</div>
			</div>
			
			<div class="Add_p_s">
             <label class="form-label col-2">兑换积分：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="spoint" ></div>
			</div>
			...
			<div class="formControls col-10">
				...
				<td>
					<%-- <c:if test="${items.pic !=null}"> --%>
						...
						<br/>
					<%-- </c:if> --%>
					<input type="file"  name="shopinfo_pic" src="/pic/${shopinfo_pic}" onchange="preView(this)"/> 
					<span>预览</span><br/>

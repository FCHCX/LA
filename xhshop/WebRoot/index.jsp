...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
                     ...
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 商品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
                         <li class="home"><a  href="javascript:void(0)" onclick="searchItems()" title="商品类表" class="iframeurl"><i class="icon-double-angle-right"></i>产品类表</a></li>					
								<script type="text/javascript">
									function searchItems(){
										$("#iframe").get(0).src ='${pageContext.request.contextPath}/items/searchItems.action';
									}
								</script>	
                  ...
                  <li>
                    ...
                    <li class="home"><a href="javascript:void(0)" name="member-Grading.html" title="积分管理"  class="iframeurl"><i class="icon-double-angle-right"></i>积分管理</a></li>
				  ...
				  <li><a href="#" class="dropdown-toggle"><i class="icon-laptop"></i><span class="menu-text"> 仓储管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)" name="Shop_list.html" title="仓储列表" class="iframeurl"><i class="icon-double-angle-right"></i>仓储列表</a></li>
                                <li class="home"><a href="javascript:void(0)" name="Shops_Audit.html" title="仓储审核" class="iframeurl"><i class="icon-double-angle-right"></i>仓储审核<span class="badge badge-danger">5</span></a></li>
							</ul>
						</li>
						<li><a href="#" class="dropdown-toggle"><i class="icon-comments-alt"></i><span class="menu-text"> 商品留言 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
						...
						<li><a href="#" class="dropdown-toggle"><i class="icon-bookmark"></i><span class="menu-text"> 编辑 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)" onclick="searchNotice()" title="公告" class="iframeurl"><i class="icon-double-angle-right"></i>公告</a></li>
								<script type="text/javascript">
									function searchNotice(){
										$("#iframe").get(0).src ='${pageContext.request.contextPath}/notice/searchNotice.action';
									}
								</script>
                                <li class="home"><a href="javascript:void(0)" name="article_Sort.html" title="文章列表" class="iframeurl"><i class="icon-double-angle-right"></i>文章列表</a></li>
							</ul>
						</li>                      
                        <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 管理员管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
                                ...
                                <li class="home"><a href="javascript:void(0)" name="administrator.html" title="管理员列表" class="iframeurl"><i class="icon-double-angle-right"></i>管理员列表</a></li>
								  <li class="home"><a href="javascript:void(0)" name="admin_info.html" title="管理员个人信息" class="iframeurl"><i class="icon-double-angle-right"></i>管理员个人信息</a></li>
							</ul>
						</li>
					</ul>
					</div>
